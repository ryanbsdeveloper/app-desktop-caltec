...
class Ui_Login_Widget(object):
    def setupUi(self, Login_Widget):
        ...
        Login_Widget.setMinimumSize(QSize(702, 501))
        Login_Widget.setMaximumSize(QSize(770, 524))
...
"background-color: rgb(43, 43, 43);")
        ...
        self.label_2.setGeometry(QRect(438, 210, 70, 13))
        font1 = QFont()
        ...
        self.label_2.setStyleSheet(u"border:0;color:white")
        self.email_input = QLineEdit(self.frame_3)
        self.email_input.setObjectName(u"email_input")
        self.email_input.setGeometry(QRect(430, 230, 270, 40))
        font2 = QFont()
...
"}")
        ...
        self.label_3.setGeometry(QRect(439, 280, 70, 13))
        self.label_3.setFont(font1)
        self.label_3.setStyleSheet(u"border:0;color:white")
        self.entrar_button = QPushButton(self.frame_3)
        self.entrar_button.setObjectName(u"entrar_button")
        self.entrar_button.setGeometry(QRect(478, 358, 181, 38))
...
"")
        ...
        self.entrar_button.setIconSize(QSize(20, 20))
        self._senha_input = QLineEdit(self.frame_3)
        self._senha_input.setObjectName(u"_senha_input")
        self._senha_input.setGeometry(QRect(430, 300, 271, 41))
        font3 = QFont()
...
"color:white\n"
"}")
        self._senha_input.setFrame(False)
        self._senha_input.setEchoMode(QLineEdit.Password)
        self.label_4 = QLabel(self.frame_3)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(480, 464, 90, 16))
        font4 = QFont()
        ...
        self.label_5.setGeometry(QRect(599, 463, 130, 16))
        self.label_5.setFont(font4)
        self.label_5.setStyleSheet(u"border:0;color:white")
        self.label_6 = QLabel(self.frame_3)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(55, 88, 190, 70))
        font5 = QFont()
...
"outline:0")
        ...
        self.label_7.setGeometry(QRect(56, 463, 156, 17))
        self.label_7.setFont(font6)
        self.label_7.setStyleSheet(u"border:0;color:white")
        self.label = QLabel(self.frame_3)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(260, 54, 280, 140))
        self.label.setStyleSheet(u"border:0")
        self.label.setPixmap(QPixmap(u":/icons/ori.png"))
        self.label.setScaledContents(True)
        self.label_8 = QLabel(self.frame_3)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(570, 458, 25, 25))
        ...
        self.label_9.setGeometry(QRect(52, 217, 310, 141))
        self.label_9.setFont(font6)
        self.label_9.setStyleSheet(u"border:0;color:white")
        ...
        self.mais_servicos_button.setGeometry(QRect(210, 300, 120, 17))
        self.mais_servicos_button.setFont(font2)
...
"outline:0")
        ...
        self.frame_2.setGeometry(QRect(-1, 1, 770, 45))
...
"border:0")
        ...
        self.label_11.setGeometry(QRect(270, 10, 260, 30))
        ...
        self.btn_close_windows.setGeometry(QRect(720, 2, 50, 40))
...
"background-color: rgb(218, 14, 14)}")
        ...
        self.label_30.setGeometry(QRect(13, 7, 33, 28))
        self.label_30.setMaximumSize(QSize(33, 28))
        ...
        self.btn_minimize_window.setGeometry(QRect(668, 2, 50, 40))
        self.btn_minimize_window.setMinimumSize(QSize(50, 40))
...
"}")
        ...
        self.erro.setGeometry(QRect(440, 410, 261, 21))
        font9 = QFont()
        font9.setFamily(u"Segoe UI")
        font9.setPointSize(12)
        font9.setBold(True)
        font9.setWeight(75)
        self.erro.setFont(font9)
