...
class Ui_AtualizarTelefone(object):
    def setupUi(self, AtualizarTelefone):
        ...
        self.frame_5.setMaximumSize(QSize(377, 210))
        font1 = QFont()
        font1.setFamily(u"Segoe UI")
        font1.setPointSize(27)
        self.frame_5.setFont(font1)
        self.frame_5.setStyleSheet(u"border:")
        ...
        self.pushButton.setGeometry(QRect(338, 15, 51, 23))
        ...
        self.frame_6.setGeometry(QRect(1, 51, 390, 160))
